...
@class GEOFeatureStyleAttributes, GEOMapItemAdditionalPlaceInfo, GEOMapItemClientAttributes, GEOMapItemPhotosAttribution, GEOMapItemPlaceAttribution, GEOMapItemReviewsAttribution, GEOMapRegion, GEOPDBusinessClaim, GEOPDFlyover, GEOPDPlace, GEOPDTransitInfo, GEOPDTransitSchedule, GEOPlace, NSArray, NSData, NSString, NSURL;
...
@property(readonly, nonatomic, getter=_transitAttributionSummaries) NSArray *transitAttributionSummaries;
@property(readonly, nonatomic, getter=_transitSchedule) GEOPDTransitSchedule *transitSchedule;
@property(readonly, nonatomic, getter=_transitInfo) GEOPDTransitInfo *transitInfo;
...
- (void)loadTransitAttributionDetails:(void (^)(NSArray *, NSError *))arg1;
