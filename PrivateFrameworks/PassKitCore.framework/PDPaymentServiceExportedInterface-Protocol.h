...
- (void)setNewAuthRandomWithCompletion:(void (^)(BOOL))arg1;
- (void)messagesForPaymentPassWithUniqueIdentifier:(NSString *)arg1 handler:(void (^)(NSSet *))arg2;
- (void)transactionsForPaymentPassWithUniqueIdentifier:(NSString *)arg1 includingSources:(unsigned int)arg2 limit:(int)arg3 handler:(void (^)(NSSet *))arg4;
