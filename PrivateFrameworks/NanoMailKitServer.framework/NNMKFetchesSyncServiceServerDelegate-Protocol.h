...
@class NNMKFetchesSyncServiceServer, NNMKProtoContentRequest, NNMKProtoFetchRequest, NNMKProtoFullSyncRequest, NNMKProtoInitialSyncFinishedNotification, NNMKProtoMoreMessagesForConversationRequest, NNMKProtoMoreMessagesRequest, NNMKProtoProtectedChannelSupportedNotification;
