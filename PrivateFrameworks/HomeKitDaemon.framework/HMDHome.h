...
@property(nonatomic) long bootupRemoteAccessOnceToken; // @synthesize bootupRemoteAccessOnceToken=_bootupRemoteAccessOnceToken;
...
- (void)_removeAdditionalUser:(id)arg1 fromAccessory:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
