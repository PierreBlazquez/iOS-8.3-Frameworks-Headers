...
struct TimestampedAudioBufferList {
    ...
    struct AudioBufferList *_field5;
    unsigned int _field6;
};
...
struct sCIspMetaDataSharedOIS {
    ...
    struct sCIspOisSample _field5[510];
    struct sCIspMotionDataSample _field6[110];
    struct sCIspABWCDebugData _field7[110];
};
...
struct sCIspMotionDataSample {
    ...
    union {
        ...
        struct sCIspGyroData _field2;
        struct sCIspMotionData _field3;
    } _field3;
    unsigned short _field4;
};
