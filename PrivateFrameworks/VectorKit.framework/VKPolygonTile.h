...
- (void)buildCoastlinesWithStyleSession:(StyleResolutionSession_7ac5772b *)arg1;
- (void)buildMeshesWithStyleSession:(StyleResolutionSession_37933b75 *)arg1 device:(struct Device *)arg2 triangulator:(id)arg3 prepareExtrusion:(BOOL)arg4;
