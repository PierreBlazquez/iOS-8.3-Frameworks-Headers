...
@property(readonly, nonatomic) CDStruct_58a02532 *polygons; // @synthesize polygons=_polygons;
...
@property(readonly, nonatomic) CDStruct_f2da61b9 *pois; // @synthesize pois=_pois;
...
@property(readonly, nonatomic) CDStruct_83456a9e *buildingFootprints; // @synthesize buildingFootprints=_buildingFootprints;
...
@property(readonly, nonatomic) CDStruct_83456a9e *hiResBuildingFootprints; // @synthesize hiResBuildingFootprints=_hiResBuildingFootprints;
