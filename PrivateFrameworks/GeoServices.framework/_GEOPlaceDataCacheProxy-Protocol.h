...
@class GEOPDPlace, NSDictionary, NSObject<OS_dispatch_queue>;

@protocol _GEOPlaceDataCacheProxy <NSObject>
- (void)shrinkToSize:(unsigned long long)arg1 finished:(void (^)(unsigned long long))arg2 onQueue:(NSObject<OS_dispatch_queue> *)arg3;
- (void)calculateFreeableSpaceWithHandler:(void (^)(unsigned long long))arg1 onQueue:(NSObject<OS_dispatch_queue> *)arg2;
