...
@class HDSQLiteDatabase, HDSQLiteStatement, NSArray, NSDictionary, NSMutableDictionary, NSSet, NSString;
...
- (BOOL)getValuesForProperties:(NSArray *)arg1 withDatabase:(HDSQLiteDatabase *)arg2 applier:(void (^)(NSArray *, id *))arg3;
