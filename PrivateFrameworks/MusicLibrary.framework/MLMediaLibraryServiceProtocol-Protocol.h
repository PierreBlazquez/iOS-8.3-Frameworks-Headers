...
@class NSArray, NSData, NSDictionary, NSFileHandle, NSString, NSUUID;
...
- (oneway void)performImportFromSource:(unsigned int)arg1 intoDatabaseAtPath:(NSString *)arg2 withTrackData:(NSData *)arg3 withPlaylistData:(NSData *)arg4 withFileHandle:(NSFileHandle *)arg5 options:(NSDictionary *)arg6 identifier:(NSUUID *)arg7 completionHandler:(void (^)(BOOL, NSError *, NSData *))arg8;
