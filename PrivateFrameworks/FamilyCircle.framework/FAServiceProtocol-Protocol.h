...
- (void)fetchFamilyMemberPhotoWithDSID:(NSNumber *)arg1 hashedDSID:(NSString *)arg2 size:(int)arg3 localFallback:(BOOL)arg4 options:(NSDictionary *)arg5 replyBlock:(void (^)(NSData *, int, NSError *))arg6;
