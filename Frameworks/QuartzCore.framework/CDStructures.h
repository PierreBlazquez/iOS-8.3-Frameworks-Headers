...
struct _CAEAGLNativeWindow {
    ...
    unsigned int _field7;
    unsigned int _field8;
    struct Atomic _field9;
    struct Atomic _field10;
    struct SpinLock _field11;
    struct _CAImageQueue *_field12;
    id _field13;
    struct x_list_struct *_field14;
    unsigned int _field15;
    ...
    struct CAEAGLBuffer *_field21;
    id _field22;
    struct Atomic _field23;
    unsigned int :1;
    unsigned int :1;
    unsigned int :1;
};
...
struct _CAMetalDrawablePrivate {
    ...
    id _field10;
    struct _CAMetalLayerPrivate *_field11;
