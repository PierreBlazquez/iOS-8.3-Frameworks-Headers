...
- (void)configureFeedCollectionViewLayout:(id)arg1 forCollectionViewType:(int)arg2 collectionViewSize:(struct CGSize)arg3 contentInset:(struct UIEdgeInsets)arg4;
