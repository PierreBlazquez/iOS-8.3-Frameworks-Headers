...
- (void)renderedStrip:(PUGridRenderedStrip *)arg1 enumerateAssetsForVisualSection:(int)arg2 inVisualItemRange:(struct _NSRange)arg3 usingBlock:(void (^)(int, PHAsset *, char *))arg4;
@end
