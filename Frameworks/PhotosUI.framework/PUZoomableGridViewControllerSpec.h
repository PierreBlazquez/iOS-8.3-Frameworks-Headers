...
@property(readonly, nonatomic) int collectionsLevelCellFillMode;
...
@property(readonly, nonatomic) int yearsLevelCellFillMode;
...
@property(readonly, nonatomic) int fullMomentsLevelCellFillMode;
