...
@interface UIStatusBarServerThread : NSThread
{
    ...
    CDStruct_0dcac612 _statusBarData;
    CDStruct_0dcac612 _composedStatusBarData;
    CDStruct_787df3f0 _overrides;
...
- (void)_postStatusBarOverrideData:(CDStruct_787df3f0 *)arg1;
...
- (void)_postStatusBarData:(CDStruct_0dcac612 *)arg1 actions:(int)arg2;
- (CDStruct_787df3f0 *)_statusBarOverrideData;
