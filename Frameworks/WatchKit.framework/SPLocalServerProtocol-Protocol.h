...
- (void)removeApplicationWithIdentifier:(NSString *)arg1 installer:(NSString *)arg2 completion:(void (^)(int))arg3;
- (void)installApplicationWithIdentifier:(NSString *)arg1 installer:(NSString *)arg2 completion:(void (^)(int))arg3;
