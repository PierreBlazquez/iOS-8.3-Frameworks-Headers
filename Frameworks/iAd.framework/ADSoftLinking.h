...
@property(readonly, nonatomic) CDUnknownFunctionPointerType IOSurfaceCreate;
...
@property(readonly, nonatomic) CDUnknownFunctionPointerType CVPixelBufferRelease;
@property(readonly, nonatomic) CDUnknownFunctionPointerType VTImageRotationSessionRelease;
@property(readonly, nonatomic) CDUnknownFunctionPointerType VTImageRotationSessionInvalidate;
@property(readonly, nonatomic) CDUnknownFunctionPointerType VTImageRotationSessionTransferImage;
@property(readonly, nonatomic) CDUnknownFunctionPointerType VTImageRotationSessionCreate;
@property(readonly, nonatomic) CDUnknownFunctionPointerType CVPixelBufferCreateWithIOSurface;
@property(readonly, nonatomic) CDUnknownFunctionPointerType IOSurfaceGetAllocSize;
@property(readonly, nonatomic) CDUnknownFunctionPointerType IOSurfaceGetHeight;
@property(readonly, nonatomic) CDUnknownFunctionPointerType IOSurfaceGetWidth;
@property(readonly, nonatomic) CDUnknownFunctionPointerType IOSurfaceGetBytesPerRow;
@property(readonly, nonatomic) CDUnknownFunctionPointerType IOSurfaceGetBaseAddress;
@property(readonly, nonatomic) CDUnknownFunctionPointerType IOSurfaceUnlock;
@property(readonly, nonatomic) CDUnknownFunctionPointerType IOSurfaceLock;
- (id)init;
