...
@property(nonatomic) int minLogBytes; // @synthesize minLogBytes=_minLogBytes;
...
@property(nonatomic) int numRequiredTransactions; // @synthesize numRequiredTransactions=_numRequiredTransactions;
